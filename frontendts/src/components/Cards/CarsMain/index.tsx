...
import { CarsMainProps } from "../../Props";

function CardCarsSearch({
  tittle,
  id,
  description,
  capacity,
  ...
  return (
    <Card className={carsCard}>
      ...
      <Card.Body className={carsBody}>
        <Text variant={2}>{tittle}</Text>
        <Text variant={3} size="16px" height="24px">
          Rp. {rentPerDay} / hari
        </Text>
        <Row>
        ...
        <Button onClick={() => handleOnClick(id)}>Pilih Mobil</Button>
      </Card.Body>
    </Card>
  );
}

export default CardCarsSearch;
